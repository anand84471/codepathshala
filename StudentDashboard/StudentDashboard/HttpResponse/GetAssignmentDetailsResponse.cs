...
{
    public class GetAssignmentDetailsResponse:APIDefaultResponse
    {
        ...
        public GetAssignmentDetailsResponse(long AssignmentId, string AssignmentName, string AssignmentDescription, string AssignmentCreationDate, int AssignmentType, string InstructorName,
