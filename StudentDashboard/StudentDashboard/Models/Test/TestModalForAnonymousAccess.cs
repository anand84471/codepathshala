...
namespace StudentDashboard.Models.Test
{
    public class TestModalForAnonymousAccess:APIDefaultResponse
    {
        ...
        public TestModalForAnonymousAccess()
        {

        }
        public TestModalForAnonymousAccess(long TestId, string TestName, string TestDescription, string TestCreationDate, int TestType, string InstructorName,
